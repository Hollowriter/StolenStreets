...
class ApplicationMain {
	...
	public static function main () {
		...
		flash.Lib.setPackage ("HaxeFlixel", "StolenStreets", "com.example.myapp", "0.0.1");
		...
		telemetryConfig.app_name = "StolenStreets";
		#end
...
class ApplicationMain {
	...
	public static function main () {
		...
		wx.App.boot (function () {
			...
			frame = wx.Frame.create (null, null, "StolenStreets", null, { width: 940, height: 480 });
			
			
			#if openfl
			var stage = wx.NMEStage.create (frame, null, null, { width: 940, height: 480 });
			#end
...
class ApplicationMain {
	...
	public static function main () {
		...
		#if (js && html5)
		#if (munit || utest)
		openfl.Lib.embed (null, 940, 480, "null");
		#end
		#else
		create ();
		#end
