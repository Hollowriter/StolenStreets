...
class PlayStateNivel2 extends FlxState{
	...
	var ogmoLoader2:FlxOgmoLoader;
	var tileMap2:FlxTilemap;
	var tmpMap2:TiledObjectLayer;
	var fondito2:FlxBackdrop;
	var musica2:FlxSound;
	...
	override public function create():Void{
		...
		for (i in 0...17){
			if (i == 0 || i == 6 || i == 7 || i == 8 || i == 9 || i == 15 || i == 16 || i == 17){
				tileMap2.setTileProperties(i, FlxObject.NONE);
			}
			else{
				tileMap2.setTileProperties(i, FlxObject.ANY);
			}
		}
	...
	override public function update(elapsed:Float):Void{
		...
		for (i in 0...(Reg.Enemigos.members.length)){
			...
			FlxG.collide(Reg.Enemigos.members[i], tileMap2);
	...
	private function entityCreator2(entityName:String, entityData:Xml):Void{
